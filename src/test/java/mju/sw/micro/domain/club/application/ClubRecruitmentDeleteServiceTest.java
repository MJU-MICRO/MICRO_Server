...
class ClubRecruitmentDeleteServiceTest extends IntegrationTestSupporter {
	...
	void deleteClubRecruitment() {
		...
		Optional<ClubRecruitment> optionalRecruitment = recruitmentRepository.findById(savedRecruitment.getId());
