...
import static mju.sw.micro.global.utils.MockConstants.MOCK_PROFILE_URL;
...
import static mju.sw.micro.global.utils.MockConstants.MOCK_MAJOR_ID;
...
public class MockFactory {
	public static User createMockUser(){
		return User.createUser(MOCK_USER_NAME,MOCK_USER_EMAIL,MOCK_PHONE_NUMBER,
			MOCK_INTEREST,MOCK_INTRODUCTION,MOCK_USER_NICKNAME,MOCK_MAJOR_ID,MOCK_MAJOR,
