...
public class MockConstants {
	public static final String MOCK_USER_EMAIL = "usertest@mju.ac.kr";
	public static final String MOCK_ADMIN_USER_EMAIL = "admintest@mju.ac.kr";
	public static final String MOCK_USER_PASSWORD = "foo1234@";
	public static final String MOCK_USER_NAME = "FooKim";
	public static final String MOCK_PHONE_NUMBER = "010-1234-4321";
	public static final String MOCK_ADMIN_PHONE_NUMBER = "010-7786-6789";
