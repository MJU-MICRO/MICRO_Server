...
public class UserApi {
	...
	public ApiResponse<Void> modifyUserPassword(@Validated @RequestPart("dto") UserPasswordRequestDto dto,
		@AuthenticationPrincipal CustomUserDetails userDetails) {
		return userService.modifyUserPassword(dto, userDetails.getEmail());
	}
